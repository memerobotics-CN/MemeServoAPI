...
enum {
  ...
  /*0x0E*/  MMS_CMD_PROFILED_VELOCITY_MOVE,
  /*0x0F*/  MMS_CMD_PROFILED_ABSOLUTE_POSITION_MOVE,
  /*0x10*/  MMS_CMD_PROFILED_RELATIVE_POSITION_MOVE,
  /*0x11*/  MMS_CMD_SET_VELOCITY_SETPOINT,
  /*0x12*/  MMS_CMD_SET_ABSOLUTE_POSITION_SETPOINT,
  /*0x13*/  MMS_CMD_SET_RELATIVE_POSITION_SETPOINT,
  /*0x14*/  MMS_CMD_SET_PROFILED_VELOCITY_SETPOINT,
  /*0x15*/  MMS_CMD_SET_PROFILED_ABSOLUTE_POSITION_SETPOINT,
  /*0x16*/  MMS_CMD_SET_PROFILED_RELATIVE_POSITION_SETPOINT,
  /*0x17*/  MMS_CMD_CONFIGURE_DIGITAL_IO,
  /*0x18*/  MMS_CMD_SET_DIGITAL_OUT,
  /*0x19*/  MMS_CMD_SET_NODE_ID,
  /*0x1A*/  MMS_CMD_SET_LOCAL_ACCEPTANCE_MASK,
  /*0x1B*/  MMS_CMD_SET_BAUD_UART,
  /*0x1C*/	MMS_CMD_SET_ZERO_POSITION,
  /*0x1D*/	MMS_CMD_RESET_POSITION,
  /*0x1E*/	MMS_CMD_START,
  /*0x1F*/	MMS_CMD_HALT,
  /*0x20*/	MMS_CMD_STOP,
